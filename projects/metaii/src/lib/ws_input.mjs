...
const pathname = 'C:/Users/Jeroen/Projects/web/devenv/devenv-public/projects/metaii/data/input/';

Input_menu.forEach((m, i) => {
    const t = Input_text[i];
...
// console.log(Input_menu, Input_text);
