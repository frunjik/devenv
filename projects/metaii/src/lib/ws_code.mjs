...
Code_count = 0;
Code_text = new Array(50);
Code_menu = new Array(50);

Code_menu[Code_count] = "Code clear";
Code_text[Code_count] = "";

Code_count++;
Code_menu[Code_count] = "c00. demo, compiled assignments c[i01,c01] ";
Code_text[Code_count] =
    "\taddress fern\n" +
    "\tliteral 5\n" +
    "\tliteral 6\n" +
...
Code_count++;
Code_menu[Code_count] = "c01. demo, AEXP assignments compiler c[i02,c02] ";
Code_text[Code_count] =
    "\tADR AEXP\n" +
    "AEXP\n" +
    "\tCLL AS\n" +
...
Code_count++;
Code_menu[Code_count] = "c02. Meta II of fig. 5, m[i03,c02]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "OUT1\n" +
    "\tTST '*1'\n" +
...
Code_count++;
Code_menu[Code_count] = "c03. Meta II reordered, c[i04,c02], m[i04,c03]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] = "c04. Meta II semicolons, c[i05,c03], m[i06,c04]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] = "c05. accept new output, c[i07,c04], m[i07,c05]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] = "c06. reject old output, c[i08,c05]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] = "c07. use new output, c[i09,c06], m[i09,c07]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] = "c08. compile to js functions, c[i10,c07]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] =
    "c07jf. compile to js functions, c[i10,c08], m[i10,c07jf]";
Code_text[Code_count] =
    "// PROGRAM compiler\n" +
...
Code_count++;
Code_menu[Code_count] = "c09. accept tokens, c[i11,c07]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] = "c09jf. accept tokens, c[i11jf,c07jf]";
Code_text[Code_count] =
    "// PROGRAM compiler\n" +
    "function compiler (input) {\n" +
    "  inbuf = input ;\n" +
...
Code_count++;
Code_menu[Code_count] = "c10. use tokens, c[i12,c09], m[i12,c10]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] = "c10jf. use tokens, c[i12jf,c09jf], m[i12jf,c10jf]";
Code_text[Code_count] =
    "// PROGRAM compiler\n" +
    "function compiler (input) {\n" +
    "  inbuf = input ;\n" +
...
Code_count++;
Code_menu[Code_count] = "c11. accept comments, c[i13,c10]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
    "PROGRAM\n" +
    "\tTST '.SYNTAX'\n" +
...
Code_count++;
Code_menu[Code_count] = "c11jf. accept comments, c[i13jf,c10jf]";
Code_text[Code_count] =
    "// PROGRAM compiler\n" +
    "function compiler (input) {\n" +
    "  inbuf = input ;\n" +
...
Code_count++;
Code_menu[Code_count] = "c12. use comments, c[i14,c11], m[i14,c12]";
Code_text[Code_count] =
    "\tADR PROGRAM\n" +
...
Code_count++;
Code_menu[Code_count] = "c12jf. use comments, c[i14jf,c11jf], m[i14jf,c12jf]";
Code_text[Code_count] =
    "// PROGRAM compiler\n" +
    "function compiler (input) {\n" +
    "  inbuf = input ;\n" +
...
Code_count++;
Code_menu[Code_count] =
    "c12js. use comments, c[i14js,c[i14js,c12jf]] m[i14js,c12js]";
Code_text[Code_count] =
    "// PROGRAM compiler\n" +
    "compiler = {\n" +
    "\n" +
...
Code_count++;
Code_menu[Code_count] = "c01ajs. demo, AEXP compile assignments c[i02a,c12js]";
Code_text[Code_count] =
    "// AEXP compiler\n" +
    "compiler = {\n" +
    "\n" +
...
Code_count++;
Code_menu[Code_count] =
    "c13js. accept backup c[i15js,c[i15js,c12js]], m[i15js,c13js]";
Code_text[Code_count] =
    "// PROGRAM compiler\n" +
    "compiler = {\n" +
    "\n" +
...
Code_count++;
Code_menu[Code_count] =
    "c01bjs. demo, AEXP2 assignments compiler c[i02b,c13js]";
Code_text[Code_count] =
    "// AEXP2 compiler\n" +
    "compiler = {\n" +
    "\n" +
...
Code_count++;
Code_menu[Code_count] = "c00a. demo, compiled assignments c[i01a,c01bjs] ";
Code_text[Code_count] =
    "\taddress fern\n" +
    "\tliteral 5\n" +
    "\tliteral 6\n" +
...
Code_count++;
Code_menu[Code_count] = "c03js. Meta II reordered, c[i04a,c13js]";
Code_text[Code_count] =
    "// PROGRAM compiler\n" +
    "compiler = {\n" +
    "\n" +
...
//         Input_text[document.InputForm.SelectedInput.selectedIndex];
// }

// /* select Code */
// function SelectCode() {
//     document.CodeForm.CodeText.value =
//         Code_text[document.CodeForm.SelectedCode.selectedIndex];
// }

// function BuildForm(name, selectedIndex, menu, count) {
//     /* build input form */
//     document.write(`<FORM NAME="${name}Form" action="none">` + "\n");
//     document.write(`<B>${name}:<\/B>` + "\n");
//     document.write(
//         `<SELECT name="Selected${name}" onChange="Select${name}();">` + "\n"
//     );
...
//             document.write(
//                 '<OPTION SELECTED VALUE="' + temp + '">' + menu[temp] + "\n"
//             );
//         } else {
//             document.write('<OPTION VALUE="' + temp + '">' + menu[temp] + "\n");
//         }
//     }

//     document.write("</SELECT>" + "\n");
//     document.write(`<TEXTAREA NAME="${name}Text" COLS=80 ROWS=50>` + "\n");
//     document.write("</TEXTAREA>" + "\n");
//     document.write("</FORM>" + "\n");
// }

// // const selectedCodeIndex  = 2;
// // const selectedInputIndex = 1; // I01

// const selectedCodeIndex = 3; // C02
// const selectedInputIndex = 3; // I03

// BuildForm("Input", selectedInputIndex, Input_menu, Input_count);
// SelectInput();

// BuildForm("Code", selectedCodeIndex, Code_menu, Code_count);
// SelectCode();

// console.log(Code_menu, Code_text);


const pathname = 'C:/Users/Jeroen/Projects/web/devenv/devenv-public/projects/metaii/data/code/';

Code_menu.forEach((m, i) => {
    const t = Code_text[i];
    const filename = m.replace(/(\.| |,)/g, '_') + '.txt';
    fs.writeFileSync(pathname + filename, t);
});
